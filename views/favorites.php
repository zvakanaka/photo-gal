...
<main>
    ...
    <table>
        ...
        <?php foreach ($faves as $fave) : ?>
            <tr>
              <td> <a href=<?php echo "'.?action=album&album=".$fave['album_name']."&photo=".strip_ext($fave['photo_name']).".webp'";?>><img src=<?php echo "'../../photo/".$fave['album_name']."/.thumb/".strip_ext($fave['photo_name']).".webp'";?> alt="Favorite image: <?php echo $fave['photo_name']." from the album: ".$fave['album_name'];?>" /></a></td>
